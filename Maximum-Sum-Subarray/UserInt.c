...
int expData(const char *filename)
{
	...
	int sampleSizes[4][10] = 	{
									...
									{50000, 100000, 150000, 200000, 250000, 300000,  350000, 400000, 450000, 500000},  				// DVC
									{500000, 1000000, 1500000, 2000000, 2500000, 3000000,  3500000, 4000000, 4500000, 5000000}  	// Linear
								};
